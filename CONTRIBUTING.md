...
1. Fork the project (```https://github.com/davidsaulrodriguez/team-roster-generator```)
2. Clone it on your machine (```git clone https://github.com/yourUsername/team-roster-generator.git```)
3. Add the upstream remote (```git remote add upstream https://github.com/davidsaulrodriguez/team-roster-generator.git```)
